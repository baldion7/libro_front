    ...
    <>
        ...
        <div
          ...
          <div>
            ...
            <p className="mt-4 text-gray-500">
              ...
              - progresivamente las habilidades comunicativas y literarias: Los estudiantes han experimentado y
              participado en la creación de un libro desde su concepción hasta su producción final, lo que les ha
              permitido adquirir un conjunto de habilidades literarias.
              <br/>
              -tambien se logro fomentar la creatividad de los estudiantes quienes exploraron su imaginación.
              <br/>
              -el Fortalecimiento de espacios de encuentro para la memoria colectiva y la participación de la comunidad:
              promoviendo la participación activa de los padres y familiares en la lectura compartida y la creación de
              historias. contribuyendo a la construcción de la memoria colectiva y a la participación de la comunidad en
              la educación.
              <br/>
              -La creación del primer libro literario hecho en la Escuela: Además, la edición de un libro titulado "En
              Algún Lugar de la Escuela: Relatos de Niños y Niñas del Barrio El Consuelo, Girón", se amplía aún más la
              contribución de este proyecto a la educación y la comunidad, proporcionando un registro duradero de las
              voces y experiencias de los estudiantes y enriqueciendo la educación de calidad en la diversidad en la
              gestión territorial.
              <br/>
              ...
              motivar a los estudiantes y conectarlos con el aprendizaje de su contexto de manera atractiva.
            </p>

            <div>
              <YouTube videoId={'OyMV6Vq-2XU'} className="flex justify-center items-center w-full rounded"/>
              <YouTube videoId={'JYpf9FTmpg8'} className="flex justify-center items-center w-full rounded"/>
            </div>
          </div>
      ...
      <div className="bg-white">
        <div
          className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
          <div>
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">EL primer libro literario:
              ¡En algún lugar de la escuela! tiene su regisrto ISBN</h2>
            <p className="mt-4 text-gray-500">
              En los recovecos de nuestra sede educativa El Consuelo, entre risas de estudiantes y murmullos de
              conocimiento de los abuelos, yace un tesoro literario esperando ser descubierto. Este registro, marcado
              con el ISBN que lo conecta a cada rincón de la escuela, es más que un simple compendio de páginas
              encuadernadas. Es un viaje a través de las historias que han sido testigos silenciosos de la vida
              estudiantil, llevándonos a lugares donde las palabras cobran vida y la imaginación se encuentra con la
              realidad. Bienvenidos a un mundo donde cada libro es una puerta a la aventura, y cada pasillo o lugar de
              la escuela esconde secretos literarios que solo aquellos con ojos curiosos podrán descubrir en <strong>Relatos
              de
              Niños y Niñas del Barrio El Consuelo, Girón"</strong> con <strong>ISBN 978-628-95822-1-5</strong> a cargo
              de Ediciones Literatonica
              en dos tomos por el grado 4, junto con un tercer tomo titulado <strong>"Severo Mostra y Mostra" con *ISBN:
      ...
      <div className="bg-white">
        <div
          className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
          <div>
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl"> Primer lanzamiento mundial de
              un libro mágico: "En algún lugar de la escuela</h2>
            <p className="mt-4 text-gray-500">
              ¡Atención a todos los abuelos, papás, mamás y familias aventureras! Estamos a punto de embarcarnos en el
              primer lanzamiento mundial de un libro mágico: "En algún lugar de la escuela".<br/> Es un evento único
              donde
              los pequeños de la casa serán los protagonistas de una representación que hará vibrar cada rincón de la
              escuela. Acompañados de invitados especiales que le dan ese toque de genialidad al asunto, la historiadora
              Patricia Sanmiguel nos llevará en un viaje a través del pasado para descubrir cómo las historias se
              entrelazan con nuestra realidad.<br/> Y para agregarle más emoción, el profesor Juan Sebastián Peña,
              experto en
              hacer que el aprendizaje sea pura diversión, será nuestra guía en esta travesía literaria.<br/> Así que
              prepárense para sumergirse en un mundo donde los niños son héroes, las palabras son magia y la escuela es
              el escenario perfecto para las aventuras más increíbles. ¡Bienvenidos a la gran premiere de "En algún
              lugar de la escuela"!
              <br/>
            </p>
      ...
      <div className="bg-white">
        <div
          className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
          <div>
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Magia entre Libros: ¡En algún
            ...
            <p className="mt-4 text-gray-500">
              ...
              Santander.<br/> Este
              evento será una explosión de creatividad y diversión, ya que contaremos con la espectacular presentación
              musical de los talentosos escritores Alekos y Amalia Low.<br/> ¡Imagina un mundo donde las palabras se
              mezclan
              con acordes musicales para crear una experiencia inolvidable! Este libro, lleno de encanto y aventuras,
              encuentra su hogar en un festival que celebra la magia de la lectura.<br/> Únanse a nosotros mientras
              exploramos las páginas de "En algún lugar de la escuela" en un entorno lleno de música, risas y
              descubrimientos.<br/> ¡Prepárense para vivir una experiencia única donde la literatura se encuentra con la
      ...
      <div className="bg-white">
        <div
          className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
          <div>
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">¡OLE, Venga Le Cuento!
              Transformando la Educación desde la Cámara del Comercio</h2>
            <p className="mt-4 text-gray-500">
              En esta presentación en la Cámara del Comercio, les contamos cómo, a través de la estrategia "Pacto por la
              Educación Santander 2030", estamos marcando la diferencia en el tejido educativo. Desde la articulación
              familia-escuela, como maestras estas prácticas no solo garantizan procesos óptimos de aprendizaje, sino
              que también fortalecen los lazos con las comunidades. Nuestra misión es clara: consolidar el Objetivo de
              Desarrollo Sostenible #4, "Garantizar una educación inclusiva, equitativa y de calidad y promover
              oportunidades de aprendizaje durante toda la vida para todos". Así que ¡OLE, venga le cuento! estamos
            ...
            <div>
              <img src={rute + '/' + 'img/WhatsApp Image 2023-11-06 at 1.45.13 AM.jpeg'}
                   className="flex justify-center items-center w-full rounded-[1rem] mb-4 "/>
              <YouTube videoId={'aCnPSwxUOdQ'} className="flex justify-center items-center w-full rounded"/>
            </div>
          </div>
          <div className="">
